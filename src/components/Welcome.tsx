...
const sections: { label: string; icon: typeof Brain; features: Feature[] }[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { icon: MessageCircle, title: "Local Chat", tag: "E2EE", tool: "lan-chat", keywords: "local chat lan chat local network encrypted end to end group room text image file e2ee" },
