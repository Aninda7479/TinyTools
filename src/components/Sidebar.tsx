...
const tools = [
  { id: "compress" as Tool, icon: Image, label: "Compress" },
  { id: "qr" as Tool, icon: QrCode, label: "QR Code" },
  { id: "process" as Tool, icon: Wand2, label: "Process" },
];

export default function Sidebar({ activeTool, onToolSelect }: SidebarProps) {
  return (
    <aside className="w-16 flex flex-col items-center py-4 gap-2 border-r border-border bg-surface/50 backdrop-blur-xl">
